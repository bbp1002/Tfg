...
namespace TFG_Cultivos.Models
{
    public class PacContext :DbContext
    {
        ...
        public DbSet<RecintoSigpac> RecintosSigpac { get; set; }
        public DbSet<DatoAgronomico> DatosAgronomicos { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RecintoSigpac>().ToTable("recintos_sigpac");
            ...
            modelBuilder.Entity<RecintoSigpac>().HasKey(r => r.IdRecinto);
            ...
            modelBuilder.Entity<RecintoSigpac>()
